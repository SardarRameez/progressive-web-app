...
import { QuizType } from '../Types/dataTypes';
...
export const QuizPage:React.FC<quizProps> = ({quiz}) => {
        ...
        <div>
            ...
            <div className="box">
                ...
                <form onSubmit={(e:React.FormEvent<EventTarget>)=>{handleQuestionScore(e,ans)}}>
                    {
                        quiz[questionNo].option.map((opt,ind)=>{
                            return (
                                <div key={ind}>
            ...
            <div>
                ...
                >
                    ...
                    <DialogContentText id="alert-dialog-description">
                        You got {score} marks out of {quiz.length}  marks .
                    </DialogContentText>
                    </DialogContent>
                    <DialogActions>
